...
wv rtgrant --attester namespace.ent --subject service.ent --expiry 1y "wave:decrypt@namespace.ent/wavemq"
```
...
```bash
wv rtgrant --attester namespace.ent --subject router.ent --expiry 1y "wave:decrypt@namespace.ent/*" 
```
